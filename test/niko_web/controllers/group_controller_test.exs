defmodule NikoWeb.GroupControllerTest do
  use NikoWeb.ConnCase

  import Niko.GroupsFixtures

  @create_attrs %{name: "test-group"}
  @update_attrs %{name: "updated-group"}
  ...
  describe "update group" do
    ...
    test "redirects when data is valid", %{conn: conn, group: group} do
      ...
      assert html_response(conn, 200) =~ "updated-group"
    end
