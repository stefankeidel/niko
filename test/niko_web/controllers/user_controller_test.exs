defmodule NikoWeb.UserControllerTest do
  use NikoWeb.ConnCase

  import Niko.AccountsFixtures

  @create_attrs %{display_name: "some display_name", email: "test@example.com"}
  @update_attrs %{display_name: "some updated display_name", email: "updated@example.com"}
  @invalid_attrs %{display_name: nil, email: nil}
